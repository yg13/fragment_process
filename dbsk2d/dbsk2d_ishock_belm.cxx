...
bool dbsk2d_ishock_belm::is_wavefront_alive(double eta, double time)
{
  ...
  double r;
  if (this==shock->lBElement()){
//    vcl_cout << "shock id: " << shock->id() << " eta: " << eta << vcl_endl;
...
//  vcl_cout << "shock map size is " <<shock_map_.size() << vcl_endl;
...
//  vcl_cout << "In dbsk2d_ishock_belm::get_shock_at, id: " << shock->id() << vcl_endl;
